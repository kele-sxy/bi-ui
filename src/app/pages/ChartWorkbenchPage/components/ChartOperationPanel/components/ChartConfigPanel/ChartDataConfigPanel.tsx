...
import { BE_MODE, ChartDataSectionType } from 'app/constants';
    ...
    const getSectionComponent = (config, index) => {
      ...
      switch (props.config?.type) {
        ...
        case ChartDataSectionType.Info:
          return !BE_MODE && <PaletteDataConfig.InfoTypeSection {...props} />;
        case ChartDataSectionType.Color:
          return !BE_MODE && <PaletteDataConfig.ColorTypeSection {...props} />;
