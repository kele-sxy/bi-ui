...
// qingyang add for 定制修改
export const BE_MODE = true;
export const EDGE_RET_OK = 200;
export const BE_LOGIN = true;
export const MSG_BACK = 'MSG_BACK';
export const MSG_VIEW_DETAIL = 'MSG_VIEW_DETAIL';
